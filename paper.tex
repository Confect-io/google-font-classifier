...
\midrule
Misclassifications & \texttt{XX / XX} \\
Mean misclassification severity & \texttt{X.XXXX} \\
Severity-weighted error rate (SWER) & \texttt{X.XXXX} \\
Random baseline SWER & \texttt{X.XXXX} \\
Relative severity (SWER / random) & \texttt{X.XXXX} \\
\bottomrule
\end{tabular}
\end{table}
