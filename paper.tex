...
\end{equation}
The absolute value of SWER depends on an arbitrary choice of distance normalization and is therefore not directly interpretable. However, the \emph{relative severity}---the ratio of the model's SWER to the expected SWER under uniform random predictions---is a dimensionless quantity that cancels the normalization constant, analogous to forming a dimensionless group in the Buckingham Pi theorem:
\begin{equation}
