...
\begin{tabular}{lrrr}
\toprule
\textbf{Method} & \textbf{Trainable Params} & \textbf{Top-1 Acc} & \textbf{95\% CI} \\
\midrule
ResNet-50 (CNN)      & 25.6M & 98.8\% & $\pm$0.17\% \\
\midrule
\multicolumn{4}{l}{\emph{DINOv2-Base backbone:}} \\
Linear Probe         & 606K  & 36.6\% & $\pm$0.75\% \\
LoRA ($r{=}4$)       & 753K  & 97.9\% & $\pm$0.21\% \\
LoRA ($r{=}8$)       & 900K  & 98.7\% & $\pm$0.16\% \\
LoRA ($r{=}16$)      & 1.2M  & 98.7\% & $\pm$0.16\% \\
Full Fine-Tuning     & 87.2M & 93.4\% & $\pm$0.31\% \\
\bottomrule
\end{tabular}
\end{table}
