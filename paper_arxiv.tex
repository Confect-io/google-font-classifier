...
\begin{tabular}{lrrrr}
\toprule
\textbf{Method} & \textbf{Trainable Params} & \textbf{Top-1 Acc} & \textbf{95\% CI} & \textbf{SWER $\Pi$} \\
\midrule
