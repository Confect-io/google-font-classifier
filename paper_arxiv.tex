...
The best-performing configuration (LoRA $r{=}8$) achieves \textbf{99.0\% top-1 accuracy} on the held-out test set across 394 font classes (Table~\ref{tab:severity}). Table~\ref{tab:baselines} compares all methods at a fixed 50-epoch budget. Given the fine-grained nature of the task---many classes differ only in weight (e.g., Roboto-300 vs.\ Roboto-400) or subtle stylistic features---this represents strong performance.
