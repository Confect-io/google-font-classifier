...
\begin{table}[h]
\centering
\caption{Comparison of fine-tuning strategies on DINOv2-Base with 394 font classes. All methods use the same training data, hyperparameters (where applicable), and evaluation protocol.}
\label{tab:baselines}
\begin{tabular}{lrrrr}
\toprule
