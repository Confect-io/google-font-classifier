...
\begin{figure}[t]
    ...
    \caption{Left: training and validation loss for LoRA $r{=}8$ and full fine-tuning. Right: generalization gap (validation loss minus smoothed training loss). Full fine-tuning exhibits a widening gap indicative of overfitting, while LoRA maintains a narrow gap throughout training.}
